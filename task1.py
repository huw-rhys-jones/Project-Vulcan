...
print("Multiplication - note that the multiple of two numbers is called the product")
...
print("Division - note that what you get from dividing two numbers is called the quotient")
